...
- 🔥 [LeetCode2.0 Revision Sheet](https://leetcodev2.vercel.app/revision_sheet/)
...
1. **Two Pointers (1-18, 18)**
   ...
   9. [Next Permutation](./twoPointers/q31/NextPermutation.java)
   10. [Trapping Rain Water](./twoPointers/q42/TrappingRainWater.java)
   11. [Sort Colors](./twoPointers/q75/SortColors.java) (Dutch National Flag Algorithm)
   12. [Valid Palindrome](./twoPointers/q125/ValidPalindrome.java)
   13. [Linked List Cycle](./twoPointers/q141/LinkedListCycle.java) (Tortoise and Hare Algorithm)
   14. [Move Zeroes](./twoPointers/q283/MoveZeroes.java)
   15. [Reverse Vowels Of A String](./twoPointers/q345/ReverseVowelsOfAString.java)
   16. [Valid Triangle Number](./twoPointers/q611/ValidTriangleNumber.java)
   17. [Find K Closest Elements](./twoPointers/q658/FindKClosestElements.java)
   18. [Squares Of A Sorted Array](./twoPointers/q977/SquaresOfASortedArray.java)
   19. [Merge Intervals](./twoPointers/mergeIntervals/MergeIntervals.java)
...
41. **Matrixes (225-249, 25)**
    ...
    18. [Spiral Matrix III](q885)
    19. [Rotting Oranges](q994)
...
42. **Math (274-292, 19)**:
    ...
    2. [Base 2 To Base 6]()
    3. [Convert to base of 2]()
    4. [Count of pairs that can be removed from Array without changing the Mean]()
    5. [Reverse Integer](q7)
    6. [Palindrome Number](q9)
    7. [Pow(x,n)](q50)
    8. [Permutation Sequence](q60)
    9. [Sqrt(x)](q69)
    10. [Factorial Trailing Zeroes](q172)
    11. [Power of 2](q231)
    12. [Power of 3](q326)
    13. [Power of 4](q342)
    14. [Base 7](q504)
    15. [Three Equal Parts](q927)
    16. [Convert to base of -2](q1017)
    17. [Armstrong Number](q1134)
...
44. **Sorting (113-130, 18)**
    ...
    10. [Comparison: Quick]()
    11. [Comparison: QuickSelect]()
    12. [Comparison: Randomized Quick Sort]()
    13. [Comparison: Randomized QuickSelect]()
    14. [Comparison: Shell (Partially Adaptive)]()
...
60. **0/1 Bounded Knapsack DP (Subset Sum, Boolean DP) (376-385, 10)**:
...
61. **Unbounded Knapsack DP (386-391, 6)**:
...
62. **Limited Supply Bounded Knapsack DP (392, 1)**:

    1. [Coin Change with Limited Supply]()

63. **Multiple Knapsack DP (393, 1)**:
...
71. **Kadane’s Algorithm (448–452, 5)**
...
75. **Probability/Expectation DP (479–484, 6)**
...
77. **State Machine DP (492–501, 10)**
...
78. **State Compression DP (502–503, 2)**

    1. [Traveling Salesman Problem (TSP)]()
    2. [Counting Subsets]()

79. **Decision DP (504–505, 2)**

    1. [Egg Dropping Problem]()
    2. [Paint House]()

80. **Counting/Combinatorial DP (506–508, 3)**

    1. [Friends Pairing Problem]()
    2. [Paint Fence]()
    3. [Ugly Number II]()

81. **Job Scheduling DP (509–512, 4)**
