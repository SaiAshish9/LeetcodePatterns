...
// Complexity Analysis:
// Building the suffix array using the naive method takes O(n^2 log n) time due
// to sorting n suffixes each of length up to n.
// The LCP array can be built in O(n) time using Kasai's algorithm.
// Overall, this implementation is not optimal for large strings, but it is
// straightforward and easy to understand.
// Time Complexity: O(n^2 log n) for suffix array construction, O(n) for LCP
// array construction.
